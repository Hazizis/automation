...
while i <= len(sheetRange['A']):
    ...
    try:
        ...
        wait_class_show = wait.until(EC.presence_of_element_located((By.CLASS_NAME, "styles_cardContainer__u1rRD")))
        # Wait until the element with text "Rp. 18.000" appears
        element_with_price = wait.until(EC.presence_of_element_located((By.XPATH, '//*[@id="__next"]/div[1]/div/main/div/div/div/div/div/div/form/div[1]/div[3]/div/span[2]')))
        ...
        print("Harga: ", element_with_price.text)
        time.sleep(2)
