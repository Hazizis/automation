...
while i <= len(sheetRange['A']):
    ...
    try:
        ...
        time.sleep(2)
        wait.until(EC.presence_of_element_located((By.ID, "mantine-r7q-body")))
        #driver.find_element(By.CLASS_NAME, "styles_checkmark__LucGL").click()
        time.sleep(1)
        driver.find_element(By.XPATH, "//*[@id='mantine-rv-body']/div[3]/button")
        time.sleep(1)
